...
/*   Updated: 2022/01/23 17:47:13 by enena            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ScavTrap <" << this->getName() << "> attack DIFFERENT <" 
		<< target
...
{
	std::cout << "ScavTrap <" << this->getName() << "> take ANOTHER WAY <"
...
{
	std::cout << "ScavTrap <" << this->getName() << "> repair ANOTHER WAY <"
		<< amount << "> hitpoints!"
		<< std::endl;
	_hitPoints += amount;
}
...
{
	std::cout << "ScavTrap <" << this->getName() << "> now enter in Gate keeper mode. "
